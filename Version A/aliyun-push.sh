docker login --username=xiya.wu@foxmail.com --password=Hello=111! registry.cn-hangzhou.aliyuncs.com

repo_address="registry.cn-hangzhou.aliyuncs.com/xywu"
docker rmi ${repo_address}/cyber-frontend
docker rmi ${repo_address}/message-service
...
docker tag cyberchair/message-service ${repo_address}/message-service
...
docker push ${repo_address}/message-service
